  ...
  feeds: [
    {
      ...
      id: `${shortname}`,
      displayName: '@kdanni.hu - #phototgraphy',
      description: 'My posts with #phototgraphy hashtags',
    },
  ],
}
// avatars/camera.jpg
